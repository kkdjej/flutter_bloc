...
void main() {
  ...
  group('WeatherPage', () {
    ...
    testWidgets('renders WeatherView', (tester) async {
      await tester.pumpWidget(RepositoryProvider.value(
          value: weatherRepository, child: MaterialApp(home: WeatherPage())));
  ...
  group('WeatherView', () {
    ...
    testWidgets('state is cached', (tester) async {
      when<dynamic>(() => hydratedStorage.read('WeatherCubit'))
    ...
    testWidgets('navigates to SettingPage when setting icon is tapperd',
        (tester) async {
      when(() => weatherCubit.state).thenReturn(WeatherState());
      await tester.pumpWidget(BlocProvider.value(
          value: weatherCubit, child: MaterialApp(home: WeatherView())));
    ...
    testWidgets('triggers refreshWeather on pull to refresh', (tester) async {
      ...
      await tester.fling(find.text('London'), const Offset(0.0, 500.0), 1000.0);
      await tester.pumpAndSettle();
